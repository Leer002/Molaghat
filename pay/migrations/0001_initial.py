    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(blank=True, max_length=36, verbose_name='token')),
                ...
                ('gateway', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s', to='pay.gateway', verbose_name='gateway')),
                ('items', models.ManyToManyField(blank=True, to='carts.cartiteminfo', verbose_name='items')),
